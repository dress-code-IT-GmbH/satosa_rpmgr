...
# pattern: https://pytest-django.readthedocs.io/en/latest/database.html#populate-the-database-with-initial-test-data
...
@pytest.mark.django_db
def test_export_allowed_attr(django_db_setup):
    yaml_str = export_allowed_attr('https://idp1.test.wpv.portalverbund.at/idp/shibboleth')
    expected_result_path = Path('testresults/attribute_authz.yaml')
